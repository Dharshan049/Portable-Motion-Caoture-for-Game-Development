...
import { HOVER_COLLECTION, HOVER_INSERT_AFTER, HOVER_INSERT_INSIDE, INSERT_EXPLANATION, STATE_ENFORCE_STRING, STATE_EXPANDED, STATE_ID, STATE_KEYS, STATE_SEARCH_PROPERTY, STATE_SEARCH_VALUE, STATE_SELECTION, STATE_VISIBLE_SECTIONS, VALIDATION_ERROR } from '../../../constants';
...
import { forEachKey } from '../../../logic/documentState';
import { onMoveSelection } from '../../../logic/dragging';
import { forEachIndex } from '../../../utils/arrayUtils';
import { createMemoizePath } from '../../../utils/pathUtils';
import { keyIsSelected } from '../../../logic/selection';
export let value;
export let path;
export let state;
...
$: resolvedValue = (dragging === null || dragging === void 0 ? void 0 : dragging.updatedValue) !== undefined ? dragging.updatedValue : value;
$: resolvedState = (dragging === null || dragging === void 0 ? void 0 : dragging.updatedState) !== undefined ? dragging.updatedState : state;
$: resolvedSelection = (dragging === null || dragging === void 0 ? void 0 : dragging.updatedSelection) != null ? dragging.updatedSelection : selection;
...
function findContentTop() {
    var _a, _b;
    return ((_b = (_a = context.findElement([])) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect()) === null || _b === void 0 ? void 0 : _b.top) || 0;
}

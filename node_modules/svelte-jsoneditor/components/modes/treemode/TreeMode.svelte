...
import { compileJSONPointer, existsIn, getIn, immutableJSONPatch, revertJSONPatch, setIn } from 'immutable-json-patch';
...
import { CONTEXT_MENU_HEIGHT, CONTEXT_MENU_WIDTH, MAX_SEARCH_RESULTS, SCROLL_DURATION, SEARCH_UPDATE_THROTTLE, SIMPLE_MODAL_OPTIONS, STATE_ENFORCE_STRING } from '../../../constants';
import { createState, documentStatePatch, expandPath, expandSection, syncState } from '../../../logic/documentState';
import { createHistory } from '../../../logic/history';
import { createNewValue, createRemoveOperations, duplicate, extract, insert } from '../../../logic/operations';
...
import { createRecursiveSelection, createSelection, findRootPath, getInitialSelection, getSelectionDown, getSelectionLeft, getSelectionRight, getSelectionUp, isSelectionInsidePath, removeEditModeFromSelection, selectAll, SELECTION_TYPE, selectionToPartialJson } from '../../../logic/selection';
...
import { parsePartialJson, repairPartialJson } from '../../../utils/jsonUtils';
...
import { convertValue, isLargeContent } from '../../../utils/jsonUtils';
import { MAX_DOCUMENT_SIZE_EXPAND_ALL } from '../../../constants';
import { canConvert, createSelectionFromOperations } from '../../../logic/selection';
import { collapse, expandWithCallback } from '../../../logic/documentState';
...
function addHistoryItem({ previousJson, previousState, previousText, previousTextIsRepaired, previousSelection }) {
...
function handleSelect(selectionSchema, options) {
    ...
    if ((options === null || options === void 0 ? void 0 : options.ensureFocus) !== false) {
        setTimeout(() => focus());
    }
}
/**
...
function handleContextMenu(event) {
    if (readOnly || (selection === null || selection === void 0 ? void 0 : selection.edit)) {
        return;
    }
    if (event) {
    ...
    if (event && event.type === 'contextmenu' && event.target !== refHiddenInput) {
        ...
        const anchor = refContents === null || refContents === void 0 ? void 0 : refContents.querySelector('.jse-context-menu-button.jse-selected');
        if (anchor) {
            openContextMenu({
                anchor,
                offsetTop: 2,
            ...
            const rect = refContents === null || refContents === void 0 ? void 0 : refContents.getBoundingClientRect();
            if (rect) {
                openContextMenu({
                    top: rect.top + 2,
                    left: rect.left + 2,

...
import { STATE_ENFORCE_STRING, STATE_KEYS, STATE_SEARCH_PROPERTY, STATE_SEARCH_VALUE } from '../constants.js';
...
export function updateSearchResult(json, flatResults, previousResult) {
    ...
    const activePath = previousResult && previousResult.activeItem
        ...
        : undefined;
    const activeItem = activePath && existsIn(items, activePath) ? getIn(items, activePath) : flatItems[0];

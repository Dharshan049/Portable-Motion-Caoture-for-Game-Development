...
import { getKeys, getNextVisiblePath, getPreviousVisiblePath, getVisibleCaretPositions, getVisiblePaths } from './documentState.js';
 ...
 */
export function getSelectionUp(json, state, selection, keepAnchorPath = false, useFocusPath = false) {
 ...
 * @returns {Selection | null}
 */
export function getSelectionDown(json, state, selection, keepAnchorPath = false, useFocusPath = false) {
 ...
 * @returns {Selection | null}
 */
export function getSelectionLeft(json, state, selection, keepAnchorPath = false, includeInside = true) {
 ...
 * @returns {Selection | null}
 */
export function getSelectionRight(json, state, selection, keepAnchorPath = false, includeInside = true) {

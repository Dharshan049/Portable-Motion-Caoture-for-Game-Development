 ...
 */
export declare function sortObjectKeys(json: any, rootPath?: any[], direction?: number): any[];
/**
 ...
 *                                  to get the array sorted.
 */
export declare function sortArray(json: any, rootPath?: any[], propertyPath?: any[], direction?: number): {
    op: string;
    path: string;
    value: JSONData[];
}[];

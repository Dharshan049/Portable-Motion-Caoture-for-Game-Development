...
export declare function createNormalizationFunctions({ escapeControlCharacters, escapeUnicodeCharacters }: {
    escapeControlCharacters: any;
    escapeUnicodeCharacters: any;
}): {
 ...
 * @returns {string}
 */
export declare function jsonEscapeUnicode(value: any): any;
/**
 * @param {string} value
 */
export declare function jsonUnescapeUnicode(value: any): any;
/**
 * @param {string} value
 */
export declare function jsonEscapeControl(value: any): any;
/**
 * @param {string} value
 */
export declare function jsonUnescapeControl(value: any): any;
/**
 * @param {any} value
 * @return {string} value
 */
export declare function addNewLineSuffix(value: any): string;
/**
 ...
 * @returns {string}
 */
export declare function removeNewLineSuffix(text: any): any;
export declare function removeReturnsAndSurroundingWhitespace(text: any): any;
 ...
 * @returns {string | null}
 */
export declare function getSelectionTypeFromTarget(target: any): string;
/**
 * Encode a path into a string that can be used as attribute in HTML
 * @param {Path} path
 * @returns {string}
 */
export declare function encodeDataPath(path: any): string;
/**
 * Decode a path that was stringified for use as an HTML attribute
 * @param {string} pathStr
 * @returns {Path}
 */
export declare function decodeDataPath(pathStr: any): any;
/**
 * Find the data path of the given element. Traverses the parent nodes until find
 * @param {HTMLElement} target
 * @returns {Path | null}
 */
export declare function getDataPathFromTarget(target: any): any;
/**

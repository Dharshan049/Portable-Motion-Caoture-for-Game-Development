...
import { calculatePosition, convertValue, countCharacterOccurrences, estimateSerializedSize, isLargeContent, isTextContent, normalizeJsonParseError, parsePartialJson, validateContentType } from './jsonUtils.js';
describe('jsonUtils', () => {
    const jsonString = '{\n' + '  id: 2,\n' + '  name: "Jo"\n' + '}';
    const jsonString2 = '{\n' + '  "id": 2,\n' + '  name: "Jo"\n' + '}';
    ...
    it('should validate content type', () => {
        ...
        deepStrictEqual(validateContentType({ text: [1, 2, 3] }), 'Content "text" property must be string');
